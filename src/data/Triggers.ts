...
export const triggers: ITrigger[] = [
  ...
  { id: 2, triggerType: "QUEST_UPDATE", data: [0, "0_ARENA_START"] },
  { id: 3, triggerType: "QUEST_UPDATE", data: [0, "0_ARENA_ACCESS"] },
  { id: 4, triggerType: "NPC_UPDATE", data: [0, "npc_Dario", false] },
  { id: 5, triggerType: "MAP_UPDATE", data: [1, "OPEN"] },
  { id: 6, triggerType: "QUEST_UPDATE", data: [0, "0_ARENA_3FIGHTS"] },
  ...
  { id: 10, triggerType: "QUEST_UPDATE", data: [0, "0_ARENA_CLOSED"] },
  ...
  { id: 21, triggerType: "QUEST_UPDATE", data: [0, "0_ARENA_ENTER"] },
